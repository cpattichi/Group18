...
public class PerspectiveManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DisableOutlinesOnStart();
    }

    void DisableOutlinesOnStart()
    {
        // Find all objects with the Outline component and disable it
    ...
    void Update()
    {
        ...
        if ((Input.GetKeyDown(KeyCode.E) || Input.GetMouseButtonDown(0)) && isRayTouchingSomething)
        {
            if (hit.transform.tag == "Getable")
            {
                ...
                outline = takenObject.GetComponent<Outline>();
                if (outline != null)
                {
                ...
                takenObject.transform.parent = targetForTakenObjects;
        ...
        if (Input.GetKey(KeyCode.E) || Input.GetMouseButton(0))
        {
            if (takenObject != null)
            {
                // recenter the object to the center of the mesh regardless of real pivot point
                if (takenObject.GetComponent<MeshRenderer>() != null)
                {
